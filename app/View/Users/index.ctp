<div class="users index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('thunder_user_id'); ?></th>
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($user['ThunderUser']['id'], array('controller' => 'thunder_users', 'action' => 'view', $user['ThunderUser']['id'])); ?>
		</td>
		<td class="actions">
